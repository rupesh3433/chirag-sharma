...
{/* LOGO */}
          <Link to="/" className="flex items-center gap-2 group">
            <h1 className="flex items-center gap-1 text-2xl sm:text-3xl font-playfair font-bold leading-none">
              ...
              <span className="bg-gradient-to-br from-chirag-pink to-pink-400 bg-clip-text text-transparent">
                Sharma
              </span>
            </h1>
          ...
          <div className="hidden lg:flex items-center gap-7">
            ...
            <Link
              to="/book"
              className="px-4 py-1.5 rounded-full font-semibold text-sm bg-gradient-to-br from-chirag-pink to-pink-200 text-chirag-darkPurple"
            >
              Book Now
            </Link>
          ...
          <div className="hidden lg:flex items-center gap-4 ml-4">
            ...
            <SocialIcon href="https://www.tiktok.com/@_chirag_101" icon={FaTiktok} />
          </div>

          {/* MOBILE TOGGLE */}
          <button
            className="lg:hidden p-2 text-chirag-darkPurple"
      ...
      {/* ================= MOBILE MENU ================= */}
      <aside
        className={`fixed top-0 right-0 h-full w-[300px] bg-white z-50 shadow-xl transition-transform duration-200 lg:hidden ${
      ...
      >
        <div className="p-6 flex flex-col h-full">
          ...
          <nav className="flex flex-col gap-2">
            ...
            <Link
              to="/book"
              className="px-5 py-2 rounded-xl text-center font-semibold bg-gradient-to-br from-chirag-pink to-pink-200 text-chirag-darkPurple"
            >
              Book Now
            </Link>
            ...
            {/* ✅ SOCIAL ICONS — DIRECTLY BELOW ABOUT */}
            <div className="flex gap-5 pt-4 px-2">
              <SocialIcon href="https://www.instagram.com/_jinniechiragmua/" icon={FaInstagram} />
              <SocialIcon href="https://www.facebook.com/chirag.sharma.5477272/" icon={FaFacebookF} />
              <SocialIcon href="https://www.youtube.com/@jinniechiragmua" icon={FaYoutube} />
              <SocialIcon href="https://www.tiktok.com/@_chirag_101" icon={FaTiktok} />
...
const NavLink = ({ to, active, children }: any) => (
  <Link to={to} className="relative font-medium text-chirag-darkPurple hover:text-chirag-pink">
    {children}
    <span
      className={`absolute -bottom-1 left-0 h-[2px] bg-chirag-pink transition-all ${
...
const SocialIcon = ({ href, icon: Icon }: any) => (
  <a
    ...
    target="_blank"
    rel="noreferrer"
    className="text-chirag-darkPurple hover:text-chirag-pink transition-colors"
  >
    <Icon size={18} />
  </a>
);
