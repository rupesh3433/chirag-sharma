...
const InstagramVideos = ({
  ...
  const [profile, setProfile] = useState<InstagramApiResponse["user"] | null>(
    null
  );
    ...
    return (
      <div className="w-full h-full rounded-full overflow-hidden bg-black/40">
        {profile.profile_picture_url ? (
          ...
          <svg
            className="w-[6cqi] h-[6cqi] text-white m-auto"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div className="max-w-[1280px] mx-auto px-4">
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 mb-4">
              {error || "Unable to load Instagram reels at this time"}
            </p>
            <button
              onClick={fetchReels}
    ...
    <section className="pt-5 pb-0 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-[1280px] mx-auto px-2">
                    ...
                    <div className="relative w-full h-full bg-black overflow-hidden group">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                        <div
                          ...
                          style={{
                            transform:
                              hoveredId === reel.id ? "scale(1.2)" : "scale(1)",
                            opacity: hoveredId === reel.id ? 1 : 0.9,
                          }}
                        >
                          <div
                            className="w-full h-full rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center shadow-2xl"
                            style={{
                        ...
                        actions={[
                          {
                            ...
                            onClick: (e) => {
                              e.stopPropagation();
                              window.open(
                                `https://www.instagram.com/reel/${reel.code}`,
                                "_blank",
                                "noopener,noreferrer"
                              );
                            },
        ...
        <div className="md:hidden flex justify-center gap-1 mt-6">
          {Array.from({ length: Math.ceil(reels.length / cardsPerView) }).map(
            (_, idx) => (
              <div
                key={idx}
