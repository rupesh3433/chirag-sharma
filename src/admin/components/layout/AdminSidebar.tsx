      ...
      <>
        ...
        >
          ...
          <div className="h-16 flex items-center px-4 border-b">
            ...
            <Sparkles className="h-5 w-5 text-white stroke-white" />
            </div>
              <div>
...
<Sidebar
  ...
  className="
    ...
    duration-200
    ease-out
    data-[state=collapsed]:duration-75
    data-[state=collapsed]:ease-in
  "
>
...
<SidebarHeader className="h-16 border-b overflow-hidden">
  ...
  >
    ...
    <div className="w-8 h-8 shrink-0 flex items-center justify-center rounded-xl gradient-primary">
      <Sparkles className="h-4 w-4 text-white stroke-white" />
    </div>
    ...
    <div
      ...
      `}
    >
      <h2 className="font-semibold whitespace-nowrap">JinniChirag</h2>
