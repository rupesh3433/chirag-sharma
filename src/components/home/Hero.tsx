        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-lg">
              Transforming faces and creating magic through the artistry of makeup and henna. Elevate your beauty with Chirag Sharma's signature touch.
            </p>
            <div className="relative mb-8 p-4 bg-white/70 backdrop-blur-sm rounded-lg border border-chirag-pink/20 shadow-sm">
              ...
              <p className="text-right text-sm mt-2 text-chirag-darkPurple/60">— Chirag's philosophy</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/contact" className="button-primary text-center group relative overflow-hidden">
                ...
                <span className="relative z-10">Book a Glam Session</span>
              </Link>
              <Link to="/portfolio" className="button-secondary text-center">
                See My Work
              </Link>
            </div>
          </div>
          
          <div className="order-1 lg:order-2 flex justify-center animate-fade-in" style={{ animationDelay: '0.4s', transform: `translateY(${scrollY * -0.1}px)` }}>
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-4 -right-4 bg-white/90 backdrop-blur-sm p-3 rounded-full shadow-lg border border-chirag-pink/30 animate-fade-in" style={{ animationDelay: '1s' }}>
                <span className="text-chirag-darkPurple font-playfair text-sm px-2">5+ Years Experience</span>
              </div>
            </div>
          </div>
        </div>
