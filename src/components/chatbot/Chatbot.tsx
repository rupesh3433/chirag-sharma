...
`}</style>
      ...
      {!open && showHint && (
        <div className="fixed bottom-20 right-4 sm:bottom-24 sm:right-6 z-[9999]">
          <div className="relative bg-gradient-to-br from-gray-900 to-black text-white px-4 py-4 mb-3 rounded-3xl shadow-2xl max-w-[310px] border border-gray-700 animate-slide-in">
            ...
            <div className="absolute -bottom-2 right-6 w-4 h-4 bg-black transform rotate-45 border-r border-b border-gray-700" />
          </div>
        </div>
      )}
